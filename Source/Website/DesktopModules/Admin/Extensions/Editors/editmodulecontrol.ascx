    ...
    <fieldset>
        ...
        <div class="dnnFormItem">
         ...
         <div class="dnnFormItem">
            ...
            <dnn:DnnComboBox id="cboSourceFolder" runat="server" autopostback="True" Filter="Contains" />
        </div>
        <div class="dnnFormItem">
            <dnn:label id="plSource" controlname="cboSource" runat="server" />
            <dnn:DnnComboBox id="cboSource" runat="server" autopostback="True" Filter="Contains" />
        </div>
        <div class="dnnFormItem">
