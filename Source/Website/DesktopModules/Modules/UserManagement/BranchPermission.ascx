<%@ Control Language="C#" AutoEventWireup="false" CodeFile="BranchPermission.ascx.cs" Inherits="DesktopModules.Modules.UserManagement.BranchPermission" %>
    ...
    <ContentTemplate>
        <div class="form-horizontal">
            ...
            <div class="c-margin-t-40 form-group">
                ...
                <div class="col-sm-5">
                    <label>Nhóm Quyền hiện hữu</label>
                </div>
                <div class="col-sm-1"></div>
            </div>
            <div class="form-group">
