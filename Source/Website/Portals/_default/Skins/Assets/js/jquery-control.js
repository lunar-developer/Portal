...
$(function()
{
    $.prototype.autoComplete = function()
    {
        $.each($(this), function()
        {
            ...
            // Render Combobox Auto Complete
            var combobox = $create(Telerik.Web.UI.RadComboBox, {
                "_dropDownWidth": 0,
                "_maxHeight": 200,
                "_renderMode": 1,
                "_skin": "Default",
                ...
                "clientStateFieldID": "dnn_ctr1457_EmployeeInquiry_cboBranch_ClientState",
                "collapseAnimation": "{ \"duration\": 450}",
                "emptyMessage": json.emptyMessage,
                "expandAnimation": "{\"duration\": 450}",
                "filter": 1,
                "itemData": json.options,
                "localization":
                    "{ \"AllItemsCheckedString\": \"All items checked\", \"ItemsCheckedString\": \"items checked\", \"CheckAllString\": \"Check All\"}"
            },
            {
