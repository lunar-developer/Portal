(function ($)
{
    ...
    function init(opts)
    {
        ...
        {
            var $row = $(row);
            var $submenu = $row.find(options.submenuSelector);
            
            // Show the submenu
            $submenu.addClass("c-menu-visible");

            // Highlighted active row
            $row.closest("li").addClass("c-menu-hover");
        }
        ...
        var deactivateSubmenu = function(row)
        {
            ...
            $submenu.removeClass("c-menu-visible");
            $row.closest("li").removeClass("c-menu-hover");
        }
