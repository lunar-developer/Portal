	...
	<xsl:template match="root">
      ...
      <ul class="dnnadminmega">
        ...
        <li id="dnnCommonTasks" class="root">
          <a href="#">
            <xsl:value-of select ="ddr:GetString('//Modules','~/AppGlobalResources/GlobalResources.resx')"/>
          </a>
          <div class="megaborder"></div>
        </li>
        <li id="dnnCurrentPage" class="root">
          <a href="#">
            <xsl:value-of select ="ddr:GetString('//Pages','~/AppGlobalResources/GlobalResources.resx')"/>
          </a>
          <div class="megaborder"></div>
        </li>
        <li id="dnnOtherTools" class="root">
          <a href="#">
            <xsl:value-of select ="ddr:GetString('//Tools','~/AppGlobalResources/GlobalResources.resx')"/>
          </a>
          <div class="megaborder"></div>
        </li>			
			</ul>
